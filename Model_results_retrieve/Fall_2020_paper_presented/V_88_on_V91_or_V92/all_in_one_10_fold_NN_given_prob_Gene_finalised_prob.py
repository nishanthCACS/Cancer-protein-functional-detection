...
editted on 29-Sep-2020 at 3.53p.m
This mainly created to Ensample all the PDB results to finalise the results
"""
...
# make sure the 
from class_retrieve_results_ens_10_fold_NN  import retrieve_comp_results_ens_10_fold_NN
...
nn_probability=''.join([main_dir,'T_1_T_2/T_1_T_2_results/best_BIR_k3_to_5_paper_results'])
...
saving_dir_NN_retrieved = ''.join([main_dir,'Finalised_results/Paper_best_BIR_k3_to_5'])
saving_dir_primary_seq_part=''.join([ "C:/Users/nishy/Documents/Projects_UL/Continues BIBM/a_Results_for_model_train/Tier_1/clean_Finalised_probabilities_gene/2020_k_fold_results/",checking_data,'paper_best_BIR_k3_to_5/'])
#%
'''
get the genes PDB details of ONGO and TSG and Fusion to create the ROC from 2018 census model to 2020 V 91 results
Since V91 and V92 has same genes not mapped and checked again
'''
print("")
print(" V92 ")
#nn_probability_part_1=''.join([nn_probability,'/part_1'])
#nn_probability_part_2=''.join([nn_probability,'/part_2'])
nn_probability_dirs=os.listdir(nn_probability)
T_1_T_2_obj = retrieve_comp_results_ens_10_fold_NN(model_name,nn_probability,nn_probability_dirs,saving_dir_NN_retrieved)
...
#os.chdir('/')
#os.chdir(''.join([nn_probability,'/most']))    
#
#test_PDBs= pickle.load(open(''.join(["pdbs_test_",str(0),".p"]), "rb"))
#test_probabilities = pickle.load(open(''.join(["test_probabilities_",str(0),".p"]), "rb"))
#%%
