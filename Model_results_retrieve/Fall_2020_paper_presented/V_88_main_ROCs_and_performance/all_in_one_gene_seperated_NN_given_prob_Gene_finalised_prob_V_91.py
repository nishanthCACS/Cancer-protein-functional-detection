...
if SITE_MUST:
    threshold_dir_sel= ''.join(["C:/Users/nishy/Documents/Projects_UL/Continues BIBM/Uniprot_Mapping/Spring_2020/weights_assign_methods/used_Fully_clean_models/T_1/SITE/",threh_dir,str(num_amino_acids),'_aminoacid'])
