...
model_name_given='model_brain_incept_RESIDUAL_quat_with_k3_to_7_with_only_7x1_vin_1_act_swish_f_inc_1_f_d_1_SITE_msle_RMSprop_67_bal_bat'
#%%
'''For SITE selection'''
if SITE_MUST:
...
if num_amino_acids==21:
    ...
    amino_acid_dir_thresh='21_aminoacid/'
elif num_amino_acids==20:
    amino_acid_dir='20_amino_acid/'
    amino_acid_dir_thresh='20_aminoacid/'

checking_data = ''.join([clean_must_sat_dir_part_save_parts,threh_dir,amino_acid_dir,'V_91/'])
if SITE_MUST:
    threshold_dir_sel= ''.join(["C:/Users/nishy/Documents/Projects_UL/Continues BIBM/Uniprot_Mapping/Spring_2020/weights_assign_methods/used_Fully_clean_models/T_1/SITE/",threh_dir,amino_acid_dir_thresh])
...
PDB_retrieve_obj.clean_test_PDB_results(unigene_load_dir)
...
#        train_new_gene_list = pickle.load(open(''.join([name,"_train_genes_21.p"]), "rb")) 
    ...
    '''
    working_dir_fraction = threshold_dir_sel
...
ONGO_test_gene_direct_prob, ONGO_test_fin_gene_prob, ONGO_test_Ensamble_gene_prob = gene_seprated_results_finalise_fully_clean_21_SITE_MUST_old_threh("ONGO",saving_dir_NN_retrieved,saving_dir_primary_seq_part,threshold_dir_sel,SITE_MUST)
TSG_test_gene_direct_prob, TSG_test_fin_gene_prob, TSG_test_Ensamble_gene_prob = gene_seprated_results_finalise_fully_clean_21_SITE_MUST_old_threh("TSG",saving_dir_NN_retrieved,saving_dir_primary_seq_part,threshold_dir_sel,SITE_MUST)
Fusion_test_gene_direct_prob, Fusion_test_fin_gene_prob, Fusion_test_Ensamble_gene_prob = gene_seprated_results_finalise_fully_clean_21_SITE_MUST_old_threh("Fusion",saving_dir_NN_retrieved,saving_dir_primary_seq_part,threshold_dir_sel,SITE_MUST)
