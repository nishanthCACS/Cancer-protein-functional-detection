...
class retrieve_comp_results_not_valid_10_fold_NN:
    ...
    def __init__(self,model_name,nn_probability,nn_probability_left_pdb,nn_probability_overlapped_PDB_results,saving_dir,ear_prob=True):
        self.saving_dir=saving_dir
        test_prob_dic={}
        for nn_probability_sel in [nn_probability,nn_probability_left_pdb,nn_probability_overlapped_PDB_results]:
            os.chdir('/')
