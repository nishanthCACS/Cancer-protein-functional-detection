...
#model_name='model_brain_inception_only'
#model_name='model_par_inception_only'
#%%
'''For SITE selection'''
if SITE_MUST:
...
"""for threhold"""
threh_dir_sel= 'before_thresh/'

if slect_threh:
    if old_Thresh:
        threh_dir= 'before_thresh/fixed_data/'
    else:
        threh_dir= 'New_thresh/fixed_data/'
else:
    threh_dir= 'all_c_alpha/fixed_data/'
...
threshold_dir_sel= ''.join(["C:/Users/nishy/Documents/Projects_UL/Continues BIBM/Uniprot_Mapping/Spring_2020/weights_assign_methods/",clean_must_sat_dir_part_save_parts,threh_dir_sel,amino_acid_dir])
