...
class ROC_for_given_3_classes_with_probability:
    ...
    def ROC_OG_VS_Fusion(self,plot_on,conf_mat=False):
        ...
        if conf_mat:
            ...
            return self.ROC_plot(y_test,y_score,2,OG_Fusion_only=True,plot_on=True),confusion_matrix_binary 
        else:
    ...
    def ROC_TSG_VS_Fusion(self,plot_on,conf_mat=False):
        ...
        if conf_mat:
            ...
            confusion_matrix_binary[:,1]=[len(Fusion_y_test)-Fusion_correct,Fusion_correct]
            return self.ROC_plot(y_test,y_score,2,TSG_Fusion_only=True,plot_on=True),confusion_matrix_binary     
        else:
