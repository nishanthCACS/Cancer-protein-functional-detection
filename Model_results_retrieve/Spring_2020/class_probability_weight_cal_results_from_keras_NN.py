...
class probability_weight_cal_results_from_keras_NN:
    """
    ...
    def __init__(self,test_gene_list,PDB_id,probabilities, working_dir_fraction,saving_dir,name, minimum_prob_decide= 0.25,Test_set=True,straight_save=True,return_out=False):
