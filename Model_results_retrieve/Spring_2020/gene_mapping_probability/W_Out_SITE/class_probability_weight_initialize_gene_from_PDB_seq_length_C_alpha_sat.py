...
class probability_weight_initialize_gene_from_PDB_seq_length_C_alpha_sat:
    ...
    """
    def __init__(self,working_dir,saving_dir,name,threshold_length = 81,sat_PDB_dir = 'bb',Not_Fully_clean=False):
        ...
        if name=='ONGO':
            ...
            site_sat=  pickle.load(open( ''.join([name,"_train_PDBs.p"]), "rb"))
