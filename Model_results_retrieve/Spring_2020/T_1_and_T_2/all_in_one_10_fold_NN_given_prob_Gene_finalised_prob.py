...
def gene_seprated_results_finalise_fully_clean_SITE_MUST_old_threh_T_1_T_2(name,T1_T2_test_prob_dic,saving_dir_part,SITE_MUST,num_amino_acids,Tier=1):
...
#    obj = probability_weight_cal_results_from_keras_NN(test_new_gene_list,test_pdbs,test_probs, working_dir_fraction,saving_dir_part,name, minimum_prob_decide= 0.25,Test_set=True,straight_save=False,return_out=True)
    obj = probability_weight_cal_results_from_keras_NN_for_T_1_T_2(test_new_gene_list,T1_T2_test_prob_dic, working_dir_fraction,saving_dir_part,name, minimum_prob_decide= 0.25,Test_set=True,straight_save=False,return_out=True)
