...
files_test= ["ONGO_T_1_test","TSG_T_1_test","Fusion_T_1_test"]
#%%
...
f= open('Finalize_all_methods_T1_test.csv',"w+")
...
def method(i):
    os.chdir('/')
    os.chdir('C:/Users/nishy/Documents/Projects_UL/Continues BIBM/a_Results_after_success')
    f= open(''.join(['method',str(i),'_T1_test.csv']),"w+")
