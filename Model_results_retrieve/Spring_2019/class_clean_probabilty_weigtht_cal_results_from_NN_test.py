...
class clean_probability_weight_cal_results_from_NN:
    ...
    def __init__(self,working_dir_fraction, working_dir_NN_prob, unigene_test_dir, saving_dir,name,name_csv, minimum_prob_decide= 0.25):
    ...
    def calculate_prob(self):                
        ...
        for i in range(0,len(direct_pikles)):
            ...
            if  dir_1[1][0] not in PDB_id:
                print("")
                print("-----missing PDB_id for direct hit")
                print("")
