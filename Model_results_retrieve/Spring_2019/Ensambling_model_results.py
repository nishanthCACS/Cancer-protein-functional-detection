...
def finalised_prob_type(files,Type,threshold_prob, main_factor):
    ...
    for i in range(0,len(probabilities)):
        ...
        if probabilities[i][0] > probabilities[i][1] and probabilities[i][0] > probabilities[i][2]:
           final_class.append("OG")
        elif probabilities[i][1] > probabilities[i][0] and probabilities[i][1] > probabilities[i][2]:
