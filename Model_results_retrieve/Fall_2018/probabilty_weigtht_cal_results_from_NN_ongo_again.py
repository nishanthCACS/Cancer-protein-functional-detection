...
saving_dir =  "".join([saving_dir_part,name])
#os.mkdir(saving_dir)
TSG = probability_weight_cal_results_from_NN(working_dir_fraction, working_dir_NN_prob, unigene_test_dir, saving_dir,name,minimum_prob_decide)
...
saving_dir =  "".join([saving_dir_part,name])
#os.mkdir(saving_dir)
Fusion = probability_weight_cal_results_from_NN(working_dir_fraction, working_dir_NN_prob, unigene_test_dir, saving_dir,name,minimum_prob_decide)
...
problemetic_pikle ='ONGO_method_1_Hs.338207.p'#'ONGO_method_2_Hs.132966.p'#
