...
#old_Thresh=False
#model_name='best_PIR'
#model_name='best_PI_only'

#model_name='best_BIR_k3_to_7'
#model_name='best_accidental_same_NN_k_7'
...
T_1_T_2_obj = retrieve_comp_results_not_valid_10_fold_NN(model_name,nn_probability,saving_dir_NN_retrieved)
