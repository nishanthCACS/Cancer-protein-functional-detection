...
editted on 10-May-2020 at 4.53 pm
editted on 27-May-2020 at 11.06 p.m
editted on 29-Oct-2020 at 02.38 p.m
editted on 04-Nov-2020 at 09.34 a.m
"""
...
from class_retrieve_results_not_valid_10_fold_NN  import retrieve_comp_results_not_valid_10_fold_NN_ensemble
...
model_name='ensemble'
#old_Thresh=False
model_list=['best_PIR','best_PI_only','best_BIR_k3_to_7','best_accidental_same_NN_k_7','best_accidental_same_NN_k_3','best_accidental_same_NN_k_5','best_BIR_k3_to_7_with_only_7x1','best_BIR_k3_to_7_with_7x1_and_3x3','best_BI_only','best_BIR_k3_to_5']
#%%
'''For SITE selection'''
if SITE_MUST:
...
nn_probability=[]
for model_name_t in model_list:
    nn_probability_t=''.join([main_dir,'T_1_T_2/T_1_T_2_results/',model_name_t])
#nn_probability_left_pdb_part=''.join([main_dir,'T_1_T_2/left_PDB_results/',model_name])
    nn_probability.append(nn_probability_t)
    print(model_name_t)
#%%
#os.chdir('/')
...
T_1_T_2_obj = retrieve_comp_results_not_valid_10_fold_NN_ensemble(model_name,nn_probability,saving_dir_NN_retrieved)
...
#V88 resulst retrieve
if num_amino_acids==21:
    sat_load_dir='C:/Users/nishy/Documents/Projects_UL/Continues BIBM/a_Results_for_model_train/Tier_1/clean_NN_results/2020_k_fold_results/Fully_clean/SITE/before_thresh/21_amino_acid/Finalised_results'
elif num_amino_acids==20:
    sat_load_dir='C:/Users/nishy/Documents/Projects_UL/Continues BIBM/a_Results_for_model_train/Tier_1/clean_NN_results/2020_k_fold_results/Fully_clean/SITE/before_thresh/20_amino_acid/Finalised_results'

OG_V1_pdbs,TSG_V1_pdbs,Fusion_V1_pdbs,OG_test_probs_numpy,TSG_test_probs_numpy,Fusion_test_probs_numpy= T_1_T_2_obj.Helper_to_get_T_1_ROC_for_V88(sat_load_dir,PDB_list_icluded=True)
...
print('PDB OG V88: ',AUC_OG_VS_TSG_pdb[0])
print('PDB TSG V88: ',AUC_OG_VS_TSG_pdb[1])
PDB_Accuracies_T_1_V88 = test_obj.confusion_matrix_to_accuracy(confusion_matrix_test)
print(PDB_Accuracies_T_1_V88)
#%%
'''
...
PDB_Accuracies_T_1_91 = test_obj.confusion_matrix_to_accuracy(confusion_matrix_test)
print(PDB_Accuracies_T_1_91)
#%%
print("")
print("")
print("V88: ",PDB_Accuracies_T_1_V88)
print("V91: ",PDB_Accuracies_T_1_91)
AA_PDB_resulst_easy=np.zeros((2,4))
AA_PDB_resulst_easy[0,:]=PDB_Accuracies_T_1_V88
AA_PDB_resulst_easy[1,:]=PDB_Accuracies_T_1_91
print(AA_PDB_resulst_easy)
#%% 
...
print("V88: ",PDB_Accuracies_T_1_V88)
print("V91: ",PDB_Accuracies_T_1_91)
AB_Gene_resulst_easy=np.zeros((2,4))
AB_Gene_resulst_easy[0,:]=Gene_Acc_old
AB_Gene_resulst_easy[1,:]=Gene_Acc_T1
print(AB_Gene_resulst_easy)
##%%
##'''
