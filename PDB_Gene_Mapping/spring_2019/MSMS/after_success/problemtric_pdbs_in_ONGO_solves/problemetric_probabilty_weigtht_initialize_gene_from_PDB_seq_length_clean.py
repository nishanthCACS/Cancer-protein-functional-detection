# -*- coding: utf-8 -*-
"""
Created on  %(19-Apr-2019) 17.27pm
...
"""
basically written for create the pikle files for 
probabilty calculation of PDBs for ONGO genes which have 
problems with the surface identification or MSMS
...
if clean and SITE_MUST:
    ...
    saving_dir = "".join([working_dir, "/clean/",name])
    print("clean_only!")
