# -*- coding: utf-8 -*-
"""
Created on  %(01-Sep-2018) 19.40Pm
...
class probability_weight_initialize_gene_from_PDB_seq_length:
    """
    ...
    """
    def __init__(self,working_dir,saving_dir,name,threshold_length = 81):
        ...
        for j in range(0,len(sort_start_positions_index)):
            ...
            if avail_end[indexes_choosen_cov[-1][-1]] < avail_start[sort_start_positions_index[j]]:
                ...
                for k in range(len(indexes_choosen_cov)-1, -1, -1):
                    # here it only check the last PDBid is it overlapped or not
...
"""
 ...
 Method_3 uses overlapping PDB's to cover the gene        
    ...
    cov(6) = 137 ((PDB_2 and PDB_3), PDB_6 and PDB_7)
                    ...
                    (45-10/2)(0.5 P[PDB_2] + 0.5 P[PDB_3]) + (60-(20+15)/2)P[PDB_1] + (40-15/2)P[PDB_6] + 12 P[PDB_7]
   Method_3_fin = ---------------------------------------------------------------------------------------------------                                                  ---------------
                                                                    137                               
     small explonation:
