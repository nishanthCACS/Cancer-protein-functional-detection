...
@author: c00294860
editted on 06-Nov-2020 at 12.12.m
...
#main_directory =''.join(['E:/scrach_cacs_1083/bef_thresh_21/round_fixed/21_aminoacids_SITE_MUST/'])
#main_directory='E:/21_prop_bef_round/ceil'
#main_directory='E:/21_prop_bef_round/floor'
#main_directory='E:/20_prop_bef_round/floor'
main_directory='E:/20_prop_bef_round/ceil'
ONGO_dir=''.join([main_directory,'/ONGO'])
TSG_dir= ''.join([main_directory,'/TSG'])
Fusion_dir=''.join([main_directory,'/Fusion'])
