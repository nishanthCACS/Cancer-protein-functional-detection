# -*- coding: utf-8 -*-
"""
Created on %19-Nov-2019(11.11 P.m)
...
class msms_surface_MOTIF_class:
    ...
    def retrieve_info(self):
        ...
        coordinates,amino_acid,chain_id_info,resSeq, MOTIF_indexs_all = self.retrieve_c_alpha()
...
class msms_surface_class:
    ...
    def retrieve_info(self):
        ...
        ca_depth_all, res_depth_all,keys,surface = self.depth_calculator()
        coordinates,amino_acid,chain_id_info,resSeq = self.retrieve_c_alpha()
...
#        return MOTIF_indexs_all,coordinates,amino_acid,fin_res_depth_all,fin_ca_depth_all
    ...
    def retrieve_c_alpha(self):
        ...
        return coordinates,amino_acid,chain_id_info,resSeq
