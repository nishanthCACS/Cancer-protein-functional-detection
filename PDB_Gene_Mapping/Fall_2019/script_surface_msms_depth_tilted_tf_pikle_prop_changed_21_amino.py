...
editted on 06-Nov-2020 at 10.58 a.m

"""
import pickle
import os
from  class_surface_msms_depth_tilted_tf_pikle_prop_changed_21_amino_round_fix import surface_msms_depth_MOTIF_ceil_class
#%%
...
#    saving_dir_part = "C:/Users/nishy/Documents/Projects_UL/Mot_if_study_python/Fall_2019/unigene_Optimally_tilted/21_aminoacids_SITE_MUST"
    saving_dir_part = "E:/scrach_cacs_1083/bef_thresh_21/round_fixed/21_aminoacids_SITE_MUST"
...
#        del obj
    ...
    for pdb_name in train_pdb_ids_details_all:
        if pdb_name!='4MDQ':
#            print(pdb_name)
            obj = surface_msms_depth_MOTIF_ceil_class(loading_pikle_dir, saving_dir_part_train, pdb_name,height=height)
            del obj
    ...
    for pdb_name in test_pdb_ids_details_all:
        if pdb_name!='4MDQ':
#            print(pdb_name)
            obj = surface_msms_depth_MOTIF_ceil_class(loading_pikle_dir, saving_dir_part_test, pdb_name,height=height)
            del obj    
#%%
height=200
#name = "ONGO"
