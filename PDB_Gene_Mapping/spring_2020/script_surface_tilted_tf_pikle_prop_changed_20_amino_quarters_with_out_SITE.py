...
import pickle
import os
from  class_surface_tilted_tf_pikle_prop_changed_21_amino_quarters import surface_quat_class
...
#    saving_dir_part = 'E:/scrach_cacs_1083/optimaly_tilted_21_quarter'
    saving_dir_part = 'F:/ULL_Project/optimally_tilted/quater_models/W_OUT_SITE/all_c_alpha/20_amino_acid'
...
#            print(pdb_name)
            obj = surface_quat_class(loading_pikle_dir, saving_dir_part_train, pdb_name,height=height)
            del obj
    ...
    for pdb_name in test_pdb_ids_details_all:
        if pdb_name!='4MDQ' and pdb_name!='6AXG':
#            print(pdb_name)
            obj = surface_quat_class(loading_pikle_dir, saving_dir_part_test, pdb_name,height=height)
            del obj    
#%%
height=200
name = "ONGO"
