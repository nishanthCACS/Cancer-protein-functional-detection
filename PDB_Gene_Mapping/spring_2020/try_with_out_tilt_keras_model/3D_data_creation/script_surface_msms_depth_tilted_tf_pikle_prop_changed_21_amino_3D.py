...
import pickle
import os
from  class_surface_msms_depth_tilted_tf_pikle_prop_changed_21_amino_C3D import surface_msms_depth_class_3D
# surface_msms_depth_MOTIF_class_3D
...
#    saving_dir_part = "C:/Users/nishy/Documents/Projects_UL/Mot_if_study_python/Fall_2019/NO_Tilt_keras"
#    saving_dir_part = "C:/Users/nishy/Documents/Projects_UL/Mot_if_study_python/Fall_2019/unigene_Optimally_tilted/Conv3D"
    saving_dir_part = "E:/scrach_cacs_1083/Conv_3D/21_new_amino_new_thresh_NO_SITE"
...
#        del obj
    ...
    for pdb_name in train_pdb_ids_details_all:
        if pdb_name!='4MDQ':
#            print(pdb_name)
            obj = surface_msms_depth_class_3D(loading_pikle_dir, saving_dir_part_train, pdb_name,height=height)
            del obj
    ...
    for pdb_name in test_pdb_ids_details_all:
        if pdb_name!='4MDQ':
#            print(pdb_name)
            obj = surface_msms_depth_class_3D(loading_pikle_dir, saving_dir_part_test, pdb_name,height=height)
            del obj    
#%%
height=200
name = "ONGO"
