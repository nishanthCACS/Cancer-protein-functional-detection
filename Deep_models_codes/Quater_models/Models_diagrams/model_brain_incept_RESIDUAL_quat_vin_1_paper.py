...
merged = layers.concatenate([tower_q0_x1, tower_q0_x2, tower_q0_x3,tower_q1_x1,tower_q1_x2,tower_q1_x3], axis=1)
...
model = keras.models.Model(inputs=[inp_q0_x1,inp_q0_x2,inp_q0_x3 ,inp_q1_x1,inp_q1_x2,inp_q1_x3], outputs=outputs, name=model_name)
